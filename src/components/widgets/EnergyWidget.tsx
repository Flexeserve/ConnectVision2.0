...
// Cabinet temperature is a sensor reading — the scope's trend is the
// pointwise average of its stores' own readings.
    ...
    <Widget title="Energy" icon={<Zap />}>
      {(expanded) =>
        expanded ? (
          ...
          <Metric value={mean} unit="°C" caption="Avg cabinet temp" />
        )
      }
    </Widget>
  );
